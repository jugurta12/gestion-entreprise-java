        ...
        if (n == 1) {
            ...
            while (true) {
                ...
                if (choix == 1) {
                    ...
                    Client clientASupprimer = new Client(nomASupprimer, 0, "", 0.0, false); // Utilisation d'un constructeur adapté
            ...
            System.out.println("Liste entreprise non encore implémentée.");
        } else {
